...
//     bf_rt_id_t ap_data_id_dp_port;
//     bf_rt_id_t ap_data_id_caver_port;
...
//     assert(bf_status == BF_SUCCESS);
//     bf_status = bf_rt_action_name_to_id(ap_table, "SwitchIngress.set_port", &ap_action_id);
//     assert(bf_status == BF_SUCCESS);
//     bf_status = bf_rt_data_field_id_with_action_get(ap_table, "port", ap_action_id, &ap_data_id_dp_port);
//     assert(bf_status == BF_SUCCESS);
//     bf_status = bf_rt_data_field_id_with_action_get(ap_table, "caver_port", ap_action_id, &ap_data_id_caver_port);
//     assert(bf_status == BF_SUCCESS);
...
//         assert(bf_status == BF_SUCCESS);
//         bf_status = bf_rt_data_field_set_value(ap_data, ap_data_id_dp_port, dp_port);
//         assert(bf_status == BF_SUCCESS);
//         bf_status = bf_rt_data_field_set_value(ap_data, ap_data_id_caver_port, caver_port); 
//         assert(bf_status == BF_SUCCESS);
...
//     assert(bf_status == BF_SUCCESS);
//     bf_status = bf_rt_key_field_id_get(for_table, "hdr.ipv4.dst_ip", &for_key_id);
//     assert(bf_status == BF_SUCCESS);
...
//     uint32_t ip;
//     uint64_t group_id;
//     const ip_id_t* m_list = ip_group_data_lists[dev_tgt->pipe_id];
//     for (uint64_t i = 0; i < ip_SIZE; i++){
//         ip = ipv4AddrToUint32(m_list[i].ip);
//         group_id = m_list[i].id;
//         bf_status = bf_rt_key_field_set_value(for_key, for_key_id, ip);
//         assert(bf_status == BF_SUCCESS);
...
//     bf_status = bf_rt_table_from_name_get(bfrt_info, "SwitchEgress.Dre_time_update_table", &table);
//     assert(bf_status == BF_SUCCESS);
//     bf_status = bf_rt_table_entry_scope_attributes_allocate(table, &table_attributes);
//     assert(bf_status == BF_SUCCESS);
//     bf_status = bf_rt_attributes_entry_scope_symmetric_mode_set(table_attributes, false);
...
//     bf_status = bf_rt_table_key_allocate(table, &key);
//     assert(bf_status == BF_SUCCESS);
//     bf_status = bf_rt_key_field_id_get(table, "eg_md.packet_type", &key_id);
//     assert(bf_status == BF_SUCCESS);
//     bf_status = bf_rt_action_name_to_id(table, "SwitchEgress.Dre_time_update", &action_id);
//     assert(bf_status == BF_SUCCESS);
//     bf_status = bf_rt_table_action_data_allocate(table, action_id, &data);
//     assert(bf_status == BF_SUCCESS);
//     bf_status = bf_rt_table_key_reset(table, &key);
...
// void set_Dre_value_update_table(const bf_rt_target_t *dev_tgt,
//                                const bf_rt_info_hdl *bfrt_info,
//                                const bf_rt_session_hdl *session){

//     printf("start to set up Dre_value_update_table table\n");
...
//     bf_status = bf_rt_table_from_name_get(bfrt_info, "SwitchEgress.Dre_value_update_table", &table);
//     assert(bf_status == BF_SUCCESS);
//     bf_status = bf_rt_table_entry_scope_attributes_allocate(table, &table_attributes);
//     assert(bf_status == BF_SUCCESS);
//     bf_status = bf_rt_attributes_entry_scope_symmetric_mode_set(table_attributes, false);
...
//     bf_status = bf_rt_key_field_id_get(table, "eg_md.packet_type", &key_id);
//     assert(bf_status == BF_SUCCESS);
//     bf_status = bf_rt_action_name_to_id(table, "SwitchEgress.Dre_value_update", &action_id_update);
//     assert(bf_status == BF_SUCCESS);
//     bf_status = bf_rt_action_name_to_id(table, "SwitchEgress.Dre_value_read", &action_id_read);
//     assert(bf_status == BF_SUCCESS);
...
//     bf_status = bf_rt_session_complete_operations(session);
//     assert(bf_status == BF_SUCCESS);
//     printf("Dre_value_update_table table is deployed correctly!\n");
// }
...
//     printf("start to set up BestTable table\n");
...
//     bf_status = bf_rt_table_from_name_get(bfrt_info, "SwitchEgress.BestTable", &table);
//     assert(bf_status == BF_SUCCESS);
//     bf_status = bf_rt_table_entry_scope_attributes_allocate(table, &table_attributes);
//     assert(bf_status == BF_SUCCESS);
//     bf_status = bf_rt_attributes_entry_scope_symmetric_mode_set(table_attributes, false);
...
//     bf_status = bf_rt_table_key_allocate(table, &key);
//     assert(bf_status == BF_SUCCESS);
//     bf_status = bf_rt_key_field_id_get(table, "eg_md.packet_type", &key_id_type);
//     assert(bf_status == BF_SUCCESS);
//     bf_status = bf_rt_key_field_id_get(table, "hdr.ipv4.src_ip", &key_id_ip);
//     assert(bf_status == BF_SUCCESS);
//     bf_status = bf_rt_action_name_to_id(table, "SwitchEgress.check_BestTable", &action_id);
//     assert(bf_status == BF_SUCCESS);
//     bf_status = bf_rt_table_action_data_allocate(table, action_id, &data);
//     assert(bf_status == BF_SUCCESS);
//     bf_status = bf_rt_table_key_reset(table, &key);
//     assert(bf_status == BF_SUCCESS);
//     bf_status = bf_rt_data_field_id_with_action_get(table, "host", action_id, &data_id);
//     assert(bf_status == BF_SUCCESS);
//     bf_status = bf_rt_table_action_data_reset(table,action_id,&data);
//     assert(bf_status == BF_SUCCESS);
...
//     bf_status = bf_rt_session_complete_operations(session);
//     assert(bf_status == BF_SUCCESS);
//     printf("BestTable table is deployed correctly!\n");
// }

// void set_judge_acceptable_table(const bf_rt_target_t *dev_tgt,
//                                const bf_rt_info_hdl *bfrt_info,
//                                const bf_rt_session_hdl *session){
//     printf("start to set up judge_acceptable_table table\n");
...
//     bf_status = bf_rt_table_from_name_get(bfrt_info, "SwitchEgress.judge_acceptable_table", &table);
//     assert(bf_status == BF_SUCCESS);
//     bf_status = bf_rt_table_entry_scope_attributes_allocate(table, &table_attributes);
//     assert(bf_status == BF_SUCCESS);
//     bf_status = bf_rt_attributes_entry_scope_symmetric_mode_set(table_attributes, false);
...
//     bf_status = bf_rt_key_field_id_get(table, "eg_md.packet_type", &key_id);
//     assert(bf_status == BF_SUCCESS);
//     bf_status = bf_rt_action_name_to_id(table, "SwitchEgress.judge_acceptable", &action_id);
//     assert(bf_status == BF_SUCCESS);
//     bf_status = bf_rt_table_action_data_allocate(table, action_id, &data);
//     assert(bf_status == BF_SUCCESS);
//     bf_status = bf_rt_table_key_reset(table, &key);
...
//     bf_status = bf_rt_session_complete_operations(session);
//     assert(bf_status == BF_SUCCESS);
//     printf("judge_acceptable_table table is deployed correctly!\n");
// }

// void set_set_goodpath(const bf_rt_target_t *dev_tgt,
//                                const bf_rt_info_hdl *bfrt_info,
//                                const bf_rt_session_hdl *session){
//     printf("start to set up set_goodpath table\n");
...
//     bf_status = bf_rt_table_from_name_get(bfrt_info, "SwitchEgress.set_goodpath", &table);
//     assert(bf_status == BF_SUCCESS);
//     bf_status = bf_rt_table_entry_scope_attributes_allocate(table, &table_attributes);
//     assert(bf_status == BF_SUCCESS);
//     bf_status = bf_rt_attributes_entry_scope_symmetric_mode_set(table_attributes, false);
...
//     bf_status = bf_rt_key_field_id_get(table, "eg_md.packet_type", &key_id_type);
//     assert(bf_status == BF_SUCCESS);
//     bf_status = bf_rt_key_field_id_get(table, "eg_md.acceptable", &key_id_acc);
//     assert(bf_status == BF_SUCCESS);
//     bf_status = bf_rt_action_name_to_id(table, "SwitchEgress.set_goodpath_with_bestPath", &action_id_best);
//     assert(bf_status == BF_SUCCESS);
//     bf_status = bf_rt_action_name_to_id(table, "SwitchEgress.set_goodpath_with_goodPath", &action_id_good);
//     assert(bf_status == BF_SUCCESS);
...
//     assert(bf_status == BF_SUCCESS);
//     printf("reset key, data\n");

//     bf_status = bf_rt_key_field_set_value(key, key_id_type, m_CAVER_ACK_FIRST);
//     assert(bf_status == BF_SUCCESS);
//     bf_status = bf_rt_key_field_set_value(key, key_id_acc, 1);//goodpath acceptable 使用goodpath
//     assert(bf_status == BF_SUCCESS);
...
//     bf_status = bf_rt_key_field_set_value(key, key_id_type, m_CAVER_ACK_FIRST);
//     assert(bf_status == BF_SUCCESS);
//     bf_status = bf_rt_key_field_set_value(key, key_id_acc, 0);//goodpath not acceptable 使用bestpath
//     assert(bf_status == BF_SUCCESS);
...
//     bf_status = bf_rt_session_complete_operations(session);
//     assert(bf_status == BF_SUCCESS);
//     printf("set_goodpath table is deployed correctly!\n");
// }

// void set_GoodTable(const bf_rt_target_t *dev_tgt,
//                                const bf_rt_info_hdl *bfrt_info,
//                                const bf_rt_session_hdl *session){

//     printf("start to set up GoodTable table\n");
...
//     bf_status = bf_rt_table_from_name_get(bfrt_info, "SwitchEgress.GoodTable", &table);
//     assert(bf_status == BF_SUCCESS);
//     bf_status = bf_rt_table_entry_scope_attributes_allocate(table, &table_attributes);
//     assert(bf_status == BF_SUCCESS);
//     bf_status = bf_rt_attributes_entry_scope_symmetric_mode_set(table_attributes, false);
...
//     bf_status = bf_rt_key_field_id_get(table, "hdr.ipv4.src_ip", &key_id_ip);
//     assert(bf_status == BF_SUCCESS);
//     bf_status = bf_rt_action_name_to_id(table, "SwitchEgress.update_good_GoodTable", &action_id);
//     assert(bf_status == BF_SUCCESS);
//     bf_status = bf_rt_table_action_data_allocate(table, action_id, &data);
//     assert(bf_status == BF_SUCCESS);
//     bf_status = bf_rt_table_key_reset(table, &key);
...
//     bf_status = bf_rt_session_complete_operations(session);
//     assert(bf_status == BF_SUCCESS);
//     printf("GoodTable table is deployed correctly!\n");
// }
...
void init_GoodTable(const bf_rt_target_t *dev_tgt,
                               const bf_rt_info_hdl *bfrt_info,
                               const bf_rt_session_hdl *session){
    ...
    bf_status = bf_rt_table_from_name_get(bfrt_info, "SwitchIngress.GoodTable_reg", &reg);
    assert(bf_status == BF_SUCCESS);
    bf_status = bf_rt_table_key_allocate(reg, &key);
    assert(bf_status == BF_SUCCESS);
    bf_status = bf_rt_table_data_allocate(reg, &data);
    ...
    bf_status = bf_rt_key_field_id_get(reg, "$REGISTER_INDEX", &key_id);
    assert(bf_status == BF_SUCCESS);
    bf_status = bf_rt_data_field_id_get(reg, "SwitchIngress.GoodTable_reg.f1", &data_id);
    assert(bf_status == BF_SUCCESS);
    bf_rt_table_key_reset(reg, &key);
    assert(bf_status == BF_SUCCESS);
    bf_rt_table_data_reset(reg, &data);
...
void test_init_Dre_value_table(const bf_rt_target_t *dev_tgt,
    ...
    for (int i = 0; i < 4; i++) {
        bf_status = bf_rt_key_field_set_value(key, key_id, i);
        assert(bf_status == BF_SUCCESS);
        bf_status = bf_rt_data_field_set_value(data, data_id, 40000);
        assert(bf_status == BF_SUCCESS);
        bf_status = bf_rt_table_entry_add(reg, session, dev_tgt, key, data);
        assert(bf_status == BF_SUCCESS);    
        printf("add entry\n");
...
void set_caverPort2switchPort(const bf_rt_target_t *dev_tgt,
    ...
    assert(bf_status == BF_SUCCESS);
    bf_status = bf_rt_key_field_id_get(table, "hdr.caver_data.out_port", &key_id_port);
    assert(bf_status == BF_SUCCESS);
    ...
    for (size_t i = 0; i < size; i++) {
        ...
        caver_port = group[i].caver_port;
        dp_port = group[i].dp_port;
        bf_status = bf_rt_key_field_set_value(key, key_id_port, caver_port);
        assert(bf_status == BF_SUCCESS);
...
static void set_ipv4_lpm(const bf_rt_target_t *dev_tgt,
    ...
    for (uint64_t i = 0; i < ip_SIZE; i++){
        ...
        assert(bf_status == BF_SUCCESS);
        bf_status = bf_rt_data_field_set_value(for_data, for_data_id, 4);
        assert(bf_status == BF_SUCCESS);
        bf_status = bf_rt_table_entry_add(for_table, session, dev_tgt, for_key, for_data);
        assert(bf_status == BF_SUCCESS);        
    }
...
void set_inPort2caverPort(const bf_rt_target_t *dev_tgt,
    ...
    bf_status = bf_rt_table_data_allocate(table, &data);
    assert(bf_status == BF_SUCCESS);
    bf_status = bf_rt_key_field_id_get(table, "ig_intr_md.ingress_port", &key_id_port);
    assert(bf_status == BF_SUCCESS);
    ...
    for (size_t i = 0; i < size; i++) {
        ...
        caver_port = group[i].caver_port;
        dp_port = group[i].dp_port;
        bf_status = bf_rt_key_field_set_value(key, key_id_port, dp_port);
        assert(bf_status == BF_SUCCESS);
...
void set_set_acceptable_path(const bf_rt_target_t *dev_tgt,
    ...
    bf_status = bf_rt_key_field_id_get(table, "ig_md.packet_type", &key_id_type);
    assert(bf_status == BF_SUCCESS);
    bf_status = bf_rt_key_field_id_get(table, "ig_md.CE", &key_id_good);
    assert(bf_status == BF_SUCCESS);
...
void set_GoodTable(const bf_rt_target_t *dev_tgt,
    ...
    bf_status = bf_rt_table_from_name_get(bfrt_info, "SwitchIngress.GoodTable", &table);
    assert(bf_status == BF_SUCCESS);
    bf_status = bf_rt_table_entry_scope_attributes_allocate(table, &table_attributes);
    assert(bf_status == BF_SUCCESS);
    bf_status = bf_rt_attributes_entry_scope_symmetric_mode_set(table_attributes, false);
    ...
    bf_status = bf_rt_key_field_id_get(table, "hdr.ipv4.src_ip", &key_id_ip);
    assert(bf_status == BF_SUCCESS);
    bf_status = bf_rt_action_name_to_id(table, "SwitchIngress.update_good_GoodTable", &action_id);
    assert(bf_status == BF_SUCCESS);
    bf_status = bf_rt_table_action_data_allocate(table, action_id, &data);
    assert(bf_status == BF_SUCCESS);
    bf_status = bf_rt_table_key_reset(table, &key);
...
int main(void) {
    ...
    set_GoodTable(dev_tgt_0, bfrt_info, *session);
    set_GoodTable(dev_tgt_1, bfrt_info, *session);

    init_BestTable(dev_tgt_0, bfrt_info, *session);
    init_BestTable(dev_tgt_1, bfrt_info, *session);

    init_GoodTable(dev_tgt_0, bfrt_info, *session);
    init_GoodTable(dev_tgt_1, bfrt_info, *session);
    ...
    // set_Dre_value_update_table(dev_tgt_0, bfrt_info, *session);
    // set_Dre_value_update_table(dev_tgt_1, bfrt_info, *session);
    ...
    // set_set_goodpath(dev_tgt_0, bfrt_info, *session);
    // set_set_goodpath(dev_tgt_1, bfrt_info, *session);
